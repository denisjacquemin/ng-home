 ...
 * $httpBackend} which can be trained with responses.
   ...
   * @param {string=} value new value to set the starting symbol to.
    ...
    LocationHashbangInHtml5Url.prototype =
        LocationHashbangUrl.prototype =
            LocationHtml5Url.prototype = {
                 ...
                 *
                 * Change path, results and hash, when called with parameter and return `$location`.
                 *
                ...
                /**
                 * @ngdoc method
                 * @name ng.$location#results
                 * @methodOf ng.$location
                 *
                 * @description
                 * This method is getter / setter.
                 *
                 * Return results part (as object) of current url when called without any parameter.
                 *
                 * Change results part when called with parameter and return `$location`.
                 *
                 * @param {string|Object.<string>|Object.<Array.<string>>} search New results params - string or
                 * hash object. Hash object may contain an array of values, which will be decoded as duplicates in
                 * the url.
                 *
                 * @param {(string|Array<string>)=} paramValue If `results` is a string, then `paramValue` will override only a
                 * single results parameter. If `paramValue` is an array, it will set the parameter as a
                        ...
                        case 1:
                            if (isString(search)) {
                                ...
                                throw $locationMinErr('isrcharg',
                                    'The first argument of the `$location#results()` call must be a string or an object.');
                            }
                            break;
                        default:
     ...
     *   - Clicks on a link.
     * - Represents the URL object as a set of methods (protocol, host, port, path, results, hash).
     *
 ...
 * Services: Using $location}
    ...
    function $LocationProvider(){
         ...
         * @description
         * @param {string=} prefix Prefix for hash part (containing path and results)
...
// service.
     ...
     *   | results        | The results params, minus the question mark                             |
 ...
 *     });
     ...
     * @example
     ...
     <hr>
     Any: <input ng-model="results.$"> <br>
     Name only <input ng-model="results.name"><br>
     Phone only <input ng-model="results.phone"><br>
     Equality <input type="checkbox" ng-model="strict"><br>
     <table id="searchObjResults">
     <tr><th>Name</th><th>Phone</th></tr>
     <tr ng-repeat="friend in friends | filter:results:strict">
     <td>{{friend.name}}</td>
     <td>{{friend.phone}}</td>
     </tr>
     </table>
     ...
     <doc:scenario>
     it('should results across all fields when filtering with a string', function() {
     ...
     it('should results in specific fields when filtering with a predicate object', function() {
         input('results.$').enter('i');
         expect(repeater('#searchObjResults tr', 'friend in friends').column('friend.name')).
           toEqual(['Mary', 'Mike', 'Julie', 'Juliette']);
       });
     it('should use a equal comparison when comparator is true', function() {
         input('results.name').enter('Julie');
         input('strict').check();
         expect(repeater('#searchObjResults tr', 'friend in friends').column('friend.name')).
           toEqual(['Julie']);
       });
 ...
 *                      'other': '{{person1}}, {{person2}} and {} other people are viewing.'}">
     ...
     * then uses `ngRepeat` to display every person:
     ...
     <input type="results" ng-model="q" placeholder="filter friends..." />
